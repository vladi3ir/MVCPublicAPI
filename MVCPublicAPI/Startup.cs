...
namespace MVCPublicAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var appConfig = new MVCPublicAPIConfiguration();

            config.Bind("MVCPublicAPIConfiguration", appConfig);
            services.AddSingleton(appConfig);

            services.AddSingleton<IStarwarsService, StarwarsService>();
            services.AddSingleton<IStarwarsFacade, StarwarsFacade>();
            services.AddSingleton<IStarwarsStore, StarwarsStore>();
            services.AddSingleton<IPlanetService, PlanetService>();

            services.AddSingleton<IStarshipStore, StarshipStore>();

            services.AddSingleton<IHolidayService, HolidayService>();
            services.AddSingleton<IHolidayFacade, HolidayFacade>();
